        ...
        if (permission == PackageManager.PERMISSION_DENIED) {
            ...
            mFusedLocationProviderClient.getLastLocation().addOnCompleteListener(this, task -> {
                ...
                if (task.isSuccessful() && mLastKnownLocation != null) {
                    ...
                    lat2 = mLastKnownLocation.getLatitude();
                    long2 = mLastKnownLocation.getLongitude();
                    mMap.addMarker(new MarkerOptions().position(new LatLng(lat2, long2)).title("Current"));
                    Log.i("Info:", mLastKnownLocation.toString());
